...
$config = array(
     ...
     */
    'auth.adminpassword' => ((getenv('SSP_ADMIN_PASSWORD') != '') ? getenv('SSP_ADMIN_PASSWORD') : 'admin'),
     ...
     */
    'secretsalt' => ((getenv('SSP_SECRET_SALT') != '') ? getenv('SSP_SECRET_SALT') : 'nbyx9gxjb9u138po0zwb5gdni9fi84k8'),
